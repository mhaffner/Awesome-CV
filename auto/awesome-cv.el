(TeX-add-style-hook
 ...
 (lambda ()
   ...
   (TeX-add-symbols
    ...
    '("firstname" 1)
    '("name" 2)
    '("referenceaddressstyle" 1)
    '("referencerelationshipstyle" 1)
    '("referencenamestyle" 1)
    '("evaltypestyle" 1)
    '("coursetitlestyle" 1)
    '("statementsectionstyle" 1)
    '("statementtitlestyle" 1)
    ...
    '("techskilllocationstyle" 1)
    '("techskilldatestyle" 1)
    '("techskillpositionstyle" 1)
    '("techskilltitlestyle" 1)
    '("skillsetstyle" 1)
    '("skilltypestyle" 1)
    '("membershiplocationstyle" 1)
    '("membershipdatestyle" 1)
    '("membershippositionstyle" 1)
    '("membershiptitlestyle" 1)
